...
interface CreateBatchRosterScheduleModalProps {
    isOpen: boolean;
    setIsOpen: (isOpen: boolean) => void;
}

export function CreateBatchRosterScheduleModal({ isOpen, setIsOpen }: CreateBatchRosterScheduleModalProps) {
    ...
    const handleDownloadTemplate = () => {
        window.location.href = '/roster-schedules/template';
    };
            ...
            <DialogContent className="w-[95vw] max-w-md rounded-xl p-4 sm:p-6 overflow-hidden">
                <form onSubmit={submit} className="flex flex-col gap-6">
                    <DialogHeader className="text-left space-y-2">
                        <DialogTitle className="text-xl font-semibold">Import Jadwal Mengajar</DialogTitle>
                        <DialogDescription className="text-sm text-muted-foreground leading-relaxed">
                            Tambahkan jadwal mengajar secara massal menggunakan file Excel (.xlsx).
                        </DialogDescription>
                    </DialogHeader>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1 mb-3">
                                        Gunakan format tabel yang telah disediakan agar data dapat diproses dengan benar.
                                    </p>
                                    <Button 
                                        type="button" 
                                        variant="outline" 
